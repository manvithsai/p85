...
ctx.drawImage(greencar_imgTag,greencar_image_x,greencar_image_y,greencar_image_height,greencar_image_width)	
}
...
console.log("when up arrow is pressed,x="+greencar_image_x+"| y="+greencar_image_x);
uploadBackground();
uploadgreencar();
}
}
...
function left()
{
	if(greencar_image_x >=0){
		...
		console.log("when left arrow is pressed,x="+greencar_image_x+"| y="+greencar_image_x);
		uploadBackground();
		uploadgreencar();
		}
}
